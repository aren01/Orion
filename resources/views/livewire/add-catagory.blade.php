					...
					<div class="divide-y divide-gray-200">
						<div class="py-8 text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7">
							<div class="flex flex-col">
								...
								<input type="text" wire:model="catagoryname" name="catagoryname" class="px-4 py-2 border focus:ring-gray-500 focus:border-gray-900 w-full sm:text-sm border-gray-300 rounded-md focus:outline-none text-gray-600" placeholder="Enter Catagory Name"> </div>
							<div class="flex flex-col">
								<label class="leading-loose">Descrption</label>
								<input type="textbox" wire:model="catagorydescription" name="catagorydescription" class="px-4 py-2 border focus:ring-gray-500 focus:border-gray-900 w-full sm:text-sm border-gray-300 rounded-md focus:outline-none text-gray-600" placeholder="Catagory Descrption"> </div>
						</div>
